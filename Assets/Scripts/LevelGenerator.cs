	...
	public void GenerateMap()
	{
		...
		switch (mapSetting.algorithm)
		{
			...
			case Algorithm.RandomWalkTopSmoothed:
				...
				map = MapFunctions.RandomWalkTopSmoothed(map, seed, mapSetting.interval, mapSetting.topLayerOnly);
				break;
		...
		//Render the result
		MapFunctions.RenderMap(map, tilemap, tile, leftEdgeTile, rightEdgeTile, topTile);
	}
